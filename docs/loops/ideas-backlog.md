...
- proposed - bodyweight tracking (additive BodyweightEntry table + trend card) (issue #99, 2026-06-10) - re-evaluation of the 2026-06-09 rejection under the complex-features directive: the slice is strictly additive
- proposed - import training history from a Strong app CSV export (issue #100, 2026-06-10) - re-evaluation of the 2026-06-09 rejection under the directive; one format, dry-run preview, transactional, security-lens review required
- proposed - give the AI coach the user's goals and fatigue signals (issue #101, 2026-06-10) - payload + prompt input-side only, adjustments output contract unchanged, demo-provider contract tests
