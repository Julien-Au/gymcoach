...
- proposed - store + chart the detailed pace/HR track of an imported activity (issue #254, 2026-06-19) - epic: additive downsampled-track table/column, FIT record-message decode, a pace/HR-over-time chart; sliced (data -> chart -> TCX/GPX)
