...
-- Backfill heuristics match both English and Russian exercise names, since
-- Russian is a supported interface locale and imported/user-created exercises
-- may be named in either language.
